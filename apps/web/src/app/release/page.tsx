    ...
    >
      <div className="space-y-10">
        <section className="rounded-2xl border border-[var(--color-border)] bg-white/[0.02] p-6">
          ...
          <p className="mt-3 text-[var(--color-bone-muted)]">
            Internal libraries (database/executor/tooling packages) are infrastructure dependencies and are not
            published as public package artifacts.
          </p>
        </section>
        ...
        <section className="rounded-2xl border border-[var(--color-border)] bg-white/[0.02] p-6">
          ...
          <ol className="mt-3 list-inside list-decimal space-y-2 text-[var(--color-bone-muted)]">
            ...
            <li>After merge, release workflow runs validation gates and publishes eligible packages.</li>
            <li>Release provenance and npm metadata are emitted by the publish step when configured.</li>
          </ol>
        </section>
        ...
        <section className="rounded-2xl border border-[var(--color-border)] bg-white/[0.02] p-6">
          ...
          <ul className="mt-3 list-inside list-disc space-y-2 text-[var(--color-bone-muted)]">
            ...
            <li>
              GitHub auth for release PR automation via <code className="font-mono">CHANGESETS_GITHUB_TOKEN</code>.
            </li>
          </ul>
        </section>
        ...
        <section className="rounded-2xl border border-[var(--color-border)] bg-white/[0.02] p-6">
          ...
          <ul className="mt-3 list-inside list-disc space-y-2 text-[var(--color-bone-muted)]">
            <li>
              <strong>npm 404 on publish:</strong> package ownership/scope or publish target mismatch.
            </li>
            <li>
              <strong>No changesets found:</strong> release can still attempt publishing unpublished public packages.
            </li>
            <li>
              <strong>Frozen lockfile errors:</strong> run lockfile update after dependency/specifier changes before
              merging.
            </li>
          </ul>
        </section>
