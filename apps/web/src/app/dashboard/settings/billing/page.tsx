...
import { AlertTriangle, ArrowRight, CheckCircle2, CreditCard, Zap } from "lucide-react";
    ...
    <div className="space-y-10 animate-in fade-in duration-500 pb-10">
      ...
      <div className="border-b border-white/10 pb-6">
        ...
        <p className="text-muted-foreground mt-2 max-w-xl leading-relaxed">
          Monitor your current resource consumption and manage your Stripe subscription. Upgrade to
          Pro to bypass concurrency execution limits and retain logs indefinitely.
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="rounded-2xl border border-white/10 bg-[#0a0a0a] shadow-[0_0_30px_rgba(255,255,255,0.02)] p-6 relative overflow-hidden">
            <h4 className="text-lg font-semibold text-white tracking-tight mb-6">
              Current Cycle Usage
            </h4>
              ...
              <div className="flex justify-between items-end mb-2">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">
                    Total execution wall-time across all functions
                  </p>
                </div>
            ...
            <div className="mb-8">
              <div className="flex justify-between items-end mb-2">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">
                    Number of times your endpoints were hit
                  </p>
                </div>
                <div className="text-right">
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-4 flex items-start gap-3">
              ...
              <div>
                <h5 className="text-sm font-medium text-yellow-500">
                  Approaching Free-Tier Invocation Limit
                </h5>
                <p className="text-xs text-yellow-500/80 mt-1 leading-relaxed">
                  You have consumed 84% of your monthly free requests. To prevent your functions
                  from returning 429 constraints, upgrade to Pro.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6">
            ...
            <ul className="space-y-3 mb-6 text-sm text-slate-300">
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-muted-foreground" /> 100k invocations/mo
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-muted-foreground" /> 1,000s compute
              </li>
              <li className="flex items-center gap-2 text-muted-foreground line-through">
                <CheckCircle2 className="w-4 h-4 opacity-50" /> No Cron dispatcher
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-2xl border border-fuchsia-500/30 bg-gradient-to-b from-fuchsia-500/10 to-transparent p-6 relative overflow-hidden shadow-[0_0_40px_rgba(217,70,239,0.1)]">
            ...
            <ul className="space-y-3 mb-8 text-sm text-slate-300">
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-fuchsia-400" /> 10M invocations/mo
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-fuchsia-400" /> 100,000s compute
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-fuchsia-400" /> Inngest Distributed Crons
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-fuchsia-400" /> Stripe Webhook Integration
              </li>
            </ul>
