...
function messageForError(code: unknown): string {
  switch (code) {
    ...
    case "forbidden":
      return "You don't have permission to change workspace settings.";
    default:
      return "Failed to update the workspace logo. Please try again.";
  }
}

export function WorkspaceLogoCard({ initialLogo }: { initialLogo: string | null }) {
    ...
    <SettingsCard className="rounded-2xl bg-[var(--color-ink-elevated)]/70 shadow-xl">
      ...
      <SettingsCardContent>
        <div className="flex items-center gap-5">
          <WorkspaceLogo logo={displayLogo} name="Workspace" size="lg" />
