  ...
  return (
    <form action={formAction} className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-3">
        <SettingsCard className="rounded-2xl bg-[var(--color-ink-elevated)]/80 shadow-xl xl:col-span-2">
          <SettingsCardHeader>
            ...
            <SettingsCardDescription>
              Function-level overrides for `@hostfunc/sdk/ai` and `@hostfunc/sdk/agent`.
            </SettingsCardDescription>
          </SettingsCardHeader>
          <SettingsCardContent className="grid gap-4 md:grid-cols-2">
            <div className="grid gap-2">
              <Label htmlFor="aiProvider">Provider override</Label>
              <select
                id="aiProvider"
                name="aiProvider"
                value={aiProvider}
            ...
            <div className="grid gap-2">
              <Label htmlFor="aiModel">Model override</Label>
              <select
                id="aiModel"
                name="aiModel"
                value={aiModel}
            ...
            <div className="grid gap-2">
              <Label htmlFor="openaiApiKey">OpenAI API key override (optional update)</Label>
              <Input
                id="openaiApiKey"
                name="openaiApiKey"
                placeholder="sk-..."
            ...
            <div className="grid gap-2">
              <Label htmlFor="claudeApiKey">Claude API key override (optional update)</Label>
              <Input
                id="claudeApiKey"
                name="claudeApiKey"
                placeholder="sk-ant-..."
        ...
        <SettingsCard className="rounded-2xl bg-[var(--color-ink-elevated)]/80 shadow-xl">
          <SettingsCardHeader>
            ...
            <SettingsCardDescription>Current function override credential presence.</SettingsCardDescription>
          </SettingsCardHeader>
          <SettingsCardContent className="space-y-2">
            <SecretStatus label="OpenAI API key override" present={initial.hasOpenAiKey} />
            <SecretStatus label="Claude API key override" present={initial.hasClaudeKey} />
            <SecretStatus label="Vector service URL override" present={initial.hasVectorServiceUrl} />
            <SecretStatus label="Vector DB URL override" present={initial.hasVectorDatabaseUrl} />
          </SettingsCardContent>
        </SettingsCard>
      </div>
      ...
      <SettingsCard className="rounded-2xl bg-[var(--color-ink-elevated)]/80 shadow-xl">
        ...
        <SettingsCardContent className="grid gap-4 md:grid-cols-2">
          <div className="grid gap-2">
            <Label htmlFor="vectorPrimary">Primary backend override</Label>
            <select
              id="vectorPrimary"
              name="vectorPrimary"
          ...
          <div className="grid gap-2">
            <Label htmlFor="vectorSecondary">Fallback backend override</Label>
            <select
              id="vectorSecondary"
          ...
          <div className="grid gap-2">
            <Label htmlFor="vectorServiceUrl">Vector service URL override (optional update)</Label>
            <Input
              id="vectorServiceUrl"
          ...
          <div className="grid gap-2">
            <Label htmlFor="vectorDatabaseUrl">Vector database URL override (optional update)</Label>
            <Input
          ...
          <div className="space-y-1">
            ...
            {hasSuccess ? (
              ...
              <p className="text-sm text-[var(--color-bone-muted)]">
                Empty secret fields keep existing override values. Empty select fields inherit workspace
                defaults.
              </p>
            )}
          </div>
