...
import { Eye, EyeOff, Key, Lock, Plus, ShieldCheck, Trash2 } from "lucide-react";
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-white/10 pb-6">
        <div>
          ...
          <p className="text-muted-foreground mt-2 max-w-xl leading-relaxed">
            Environment variables are encrypted at rest using our native envelope encryption KMS
            engine. Your plain-text keys are never visible in logs or storage, and are only injected
            securely directly into the runtime context at invocation.
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-start w-full">
          <div className="flex-1 w-full space-y-2">
            ...
            <Input
              ...
              className="font-mono h-12 bg-black/40 border-white/10 focus-visible:ring-emerald-500 focus-visible:border-emerald-500"
            />
          </div>
          <div className="flex-1 w-full space-y-2">
            <label
