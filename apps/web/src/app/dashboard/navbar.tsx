      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-6">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="start" className="w-[220px] border-[var(--color-border)] bg-[var(--color-ink-elevated)] text-[var(--color-bone)]">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem asChild className="cursor-pointer gap-2 text-[var(--color-bone-muted)]">
        ...
        <div className="flex items-center gap-3">
          <Button size="sm" asChild className="group h-8 rounded-full bg-[var(--color-amber)] px-4 text-[var(--color-ink)] hover:bg-[var(--color-amber-hover)]">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56 border-[var(--color-border)] bg-[var(--color-ink-elevated)] text-[var(--color-bone)]" align="end" forceMount>
              <DropdownMenuLabel className="mb-2 border-b border-[var(--color-border)] pb-3 font-normal">
                <div className="flex flex-col space-y-1">
                  <p className="text-sm font-medium leading-none">
                    {user.name || "System Administrator"}
                  </p>
                  <p className="mt-1 text-xs leading-none text-[var(--color-bone-faint)]">{user.email}</p>
                </div>
              </DropdownMenuLabel>
              <DropdownMenuGroup>
