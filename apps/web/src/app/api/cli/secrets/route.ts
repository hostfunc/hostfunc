...
import { listSecretsForFunction, setSecretForFunction } from "@/server/functions";
...
/** Lists a function's secret KEYS (never values) for the hostfunc VS Code extension. */
export async function GET(req: NextRequest) {
  ...
  const items = await listSecretsForFunction(actor.orgId, fnId);
