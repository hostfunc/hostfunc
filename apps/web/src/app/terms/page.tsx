      ...
      <div className="space-y-10">
        <section className="rounded-2xl border border-[var(--color-border)] bg-white/[0.02] p-6">
          ...
          <p className="mt-3 text-[var(--color-bone-muted)]">
            By creating an account or using hostfunc, you agree to these Terms. You represent that
            you are authorized to act for your organization when creating workspaces and inviting
            members.
          </p>
        </section>
        ...
        <section className="rounded-2xl border border-[var(--color-border)] bg-white/[0.02] p-6">
          ...
          <p className="mt-3 text-[var(--color-bone-muted)]">
            Account holders are responsible for credentials, API tokens, and actions performed in
            their workspace. Workspace owners control membership, access, and billing settings.
          </p>
        </section>
        ...
        <section className="rounded-2xl border border-[var(--color-border)] bg-white/[0.02] p-6">
          ...
          <ul className="mt-3 list-inside list-disc space-y-2 text-[var(--color-bone-muted)]">
            ...
            <li>
              No use of the service to distribute malware or unauthorized data exfiltration tooling.
            </li>
          </ul>
        </section>
        ...
        <section className="rounded-2xl border border-[var(--color-border)] bg-white/[0.02] p-6">
          ...
          <p className="mt-3 text-[var(--color-bone-muted)]">
            You retain ownership of your function code and content. You grant hostfunc a limited
            license to host, execute, process, and transmit that content solely to operate and
            improve the service you requested.
          </p>
        </section>
        ...
        <section className="rounded-2xl border border-[var(--color-border)] bg-white/[0.02] p-6">
          ...
          <p className="mt-3 text-[var(--color-bone-muted)]">
            Paid plans and usage limits are billed through configured payment processors. You are
            responsible for paying applicable fees and taxes for your workspace usage.
          </p>
        </section>
        ...
        <section className="rounded-2xl border border-[var(--color-border)] bg-white/[0.02] p-6">
          ...
          <p className="mt-3 text-[var(--color-bone-muted)]">
            hostfunc is currently an evolving platform. Features, APIs, and limits may change as the
            product matures. Unless explicitly agreed in writing, no specific uptime or SLA
        ...
        <section className="rounded-2xl border border-[var(--color-border)] bg-white/[0.02] p-6">
          ...
          <p className="mt-3 text-[var(--color-bone-muted)]">
            We may suspend or terminate accounts for Terms violations, abuse, or security risk. You
        ...
        <section className="rounded-2xl border border-[var(--color-border)] bg-white/[0.02] p-6">
          ...
          <p className="mt-3 text-[var(--color-bone-muted)]">
            To the fullest extent permitted by law, hostfunc is provided as-is and as-available. You
            agree to indemnify hostfunc for claims arising from your use that violates these Terms
            or applicable law.
          </p>
        </section>
        ...
        <section className="rounded-2xl border border-[var(--color-border)] bg-white/[0.02] p-6">
          ...
          <p className="mt-3 text-[var(--color-bone-muted)]">
            ...
            for data handling and security posture.
          </p>
        </section>
      </div>
    </PolicyPageShell>
