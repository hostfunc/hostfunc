...
import { APP_URL, LOGIN_URL, SITE_URL } from "@/lib/site";
      ...
      <header className="sticky top-0 z-40 w-full border-b border-[var(--color-border)] bg-[var(--color-ink)]/85 backdrop-blur-xl">
        <div className="flex h-16 w-full items-center gap-4 px-6 lg:px-8">
          <div className="flex shrink-0 items-center gap-6">
            <Link href={SITE_URL} className="flex items-center gap-2 group w-max">
              <Logo
          ...
          <div className="ml-auto flex shrink-0 items-center gap-4">
            <div className="hidden sm:flex items-center gap-4">
              <Link
                href={`${APP_URL}`}
                className="hidden items-center rounded-full px-3 text-sm font-semibold text-[var(--color-bone-muted)] transition-colors hover:text-[var(--color-bone)] sm:flex"
              >
              ...
              <Link
                href={LOGIN_URL}
                className="inline-flex h-9 items-center rounded-full bg-[var(--color-amber)] px-5 text-sm font-bold text-[var(--color-ink)] transition-colors hover:bg-[var(--color-amber-hover)]"
              >
                Get started
              </Link>
            </div>
